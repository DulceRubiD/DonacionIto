...
<head>
    ...
    <title>Registro del Beneficiario</title>
    <meta charset="utf-8">
...
<body>
    <article>
        <section class="container">
            <h1 class="h2 text-center my-3">Beneficiario</h1>

            <form action="beneficiarios" method="POST" name="formulario" id="formulario" autocomplete="on">
                @csrf
                <fieldset>
                    ...
                    <div  class="form-group">
                        <label>Edad</label>
                        <input required type="number" id="edad" name="edad" class="form-control" placeholder="18">
